		...
		public override void AI()
		{
			if (projectile.position.HasNaNs()) {
				...
				if (projectile.localAI[0] != 2.0) {
					...
					int index = Projectile.NewProjectile(projectile.Center + Main.rand.NextVector2Circular(20f, 20f),
				...
				int index1 = Projectile.NewProjectile(projectile.Center + vector2, Vector2.Zero, projectile.type,
