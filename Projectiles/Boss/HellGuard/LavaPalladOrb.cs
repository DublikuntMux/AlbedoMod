...
namespace Albedo.Projectiles.Boss.HellGuard
{
	public class LavaPalladOrb : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int index1 = Dust.NewDust(projectile.position, projectile.width, projectile.height,
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int index1 = 0; index1 < 20; ++index1) {
				int index2 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, 0.0f, 0.0f, 100,
					new Color(), 3.5f);
				Main.dust[index2].noGravity = true;
				var dust1 = Main.dust[index2];
				dust1.velocity *= 7f;
				int index3 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, 0.0f, 0.0f, 100,
					new Color(), 1.5f);
			...
			for (int index4 = 0; index4 < 20; ++index4) {
				int index5 = Dust.NewDust(projectile.position, projectile.width, projectile.height,
				...
				int index6 = Dust.NewDust(projectile.position, projectile.width, projectile.height,
