...
namespace Albedo.Projectiles.Boss.GunMaster
{
	public class FrostShard : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (AlbedoUtils.BossIsAlive(ref AlbedoGlobalNpc.GunMaster, ModContent.NPCType<NPCs.Boss.GunMaster.GunMaster>()) && projectile.position.Y > Main.npc[AlbedoGlobalNpc.GunMaster].Center.Y + ((Main.npc[AlbedoGlobalNpc.GunMaster].localAI[3] == 1f) ? 2000 : 1400))
			{
				projectile.Kill();
			}
		}
