	...
	public class GlowLine : ModProjectile
	{
		...
		public override void AI()
		{
			...
			case 0:
			{
				...
				num = 30;
				num2 = 10f;
				NPC val13 = AlbedoUtils.NpcExists(projectile.localAI[1], ModContent.NPCType<NPCs.Boss.GunMaster.GunMaster>());
				if (val13 != null)
				{
			...
			case 3:
			{
				...
				num = 60;
				num2 = 6f;
				NPC val10 = AlbedoUtils.NpcExists(projectile.localAI[1], ModContent.NPCType<NPCs.Boss.GunMaster.GunMaster>());
				if (val10 != null)
				{
			...
			case 4:
			{
				...
				num = 150;
				num2 = 7f;
				NPC val6 = AlbedoUtils.NpcExists(projectile.localAI[1], ModContent.NPCType<NPCs.Boss.GunMaster.GunMaster>());
				if (val6 != null)
				{
			...
			case 5:
			{
				...
				num = 150;
				num2 = 10f;
				NPC val12 = AlbedoUtils.NpcExists(projectile.localAI[1], ModContent.NPCType<NPCs.Boss.GunMaster.GunMaster>());
				if (val12 != null)
				{
			...
			case 10:
			{
				...
				num = 90;
				num2 = 2f;
				NPC val3 = AlbedoUtils.NpcExists(projectile.ai[1], ModContent.NPCType<NPCs.Boss.GunMaster.GunMaster>());
				if (val3 != null)
				{
