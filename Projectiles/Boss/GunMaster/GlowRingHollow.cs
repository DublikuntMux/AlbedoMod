    ...
    public class GlowRingHollow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            switch ((int)projectile.ai[0])
            {
                ...
                case 3:
                {
                    ...
                    num2 = 180;
                    num3 = 10;
                    NPC val5 = AlbedoUtils.NpcExists(projectile.ai[1], ModContent.NPCType<NPCs.Boss.GunMaster.GunMaster>());
                    if (val5 != null)
                    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(texture2D,
                ...
                projectile.GetAlpha(lightColor), projectile.rotation, origin, this.projectile.scale, SpriteEffects.None,
                0f);
            return false;
        }
    }
