...
{
	public class GunGodDeathraySmall : BaseDeathray
	{
		public GunGodDeathraySmall()
			: base(30f, "GunGodDeathray")
		{
		}

		public override void SetStaticDefaults() => DisplayName.SetDefault("GunGod Deathray");
