...
namespace Albedo.Projectiles.Boss.GunGod
{
	...
	{
		public override void SetStaticDefaults() => Main.projFrames[projectile.type] = Main.projFrames[645];
		...
		public override Color? GetAlpha(Color lightColor) => new Color(255, 255, 255, 127) * projectile.Opacity;
