        ...
        public override void AI()
        {
            ...
            switch ((int) projectile.ai[0])
            {
                case 0:
                {
                    ...
                    num = 30;
                    num2 = 10f;
                    var val13 = AlbedoUtils.NpcExists(projectile.localAI[1],
                ...
                case 2:
                    ...
                    if (projectile.velocity != Vector2.Zero)
                    {
                        ...
                        var num6 = projectile.velocity.Length();
                ...
                case 3:
                {
                    ...
                    num = 60;
                    num2 = 6f;
                    var val10 = AlbedoUtils.NpcExists(projectile.localAI[1],
                        ModContent.NPCType<NPCs.Boss.GunGod.GunGod>());
                    if (val10 != null)
                    {
                ...
                case 4:
                {
                    ...
                    num = 150;
                    num2 = 7f;
                    var val6 = AlbedoUtils.NpcExists(projectile.localAI[1],
                        ModContent.NPCType<NPCs.Boss.GunGod.GunGod>());
                    if (val6 != null)
                    {
                ...
                case 5:
                {
                    ...
                    num = 150;
                    num2 = 10f;
                    var val12 = AlbedoUtils.NpcExists(projectile.localAI[1],
                        ModContent.NPCType<NPCs.Boss.GunGod.GunGod>());
                    if (val12 != null)
                    {
                ...
                case 6:
                {
                    ...
                    num = 90;
                    var val9 = AlbedoUtils.PlayerExists(projectile.ai[1]);
                    if (val9 != null)
                ...
                case 8:
                {
                    color = Color.Yellow;
                    num = 60;
                    var val4 = AlbedoUtils.NpcExists(projectile.ai[1], 128, 131, 129, 130);
                    if (val4 != null)
                    {
                ...
                case 9:
                {
                    ...
                    num = 120;
                    num2 = 2f;
                    var val2 = AlbedoUtils.NpcExists(projectile.ai[1], 125);
                    if (val2 != null)
                    {
                ...
                case 10:
                {
                    ...
                    num = 90;
                    num2 = 2f;
                    var val3 = AlbedoUtils.NpcExists(projectile.ai[1], ModContent.NPCType<NPCs.Boss.GunGod.GunGod>());
                    if (val3 != null)
                    {
