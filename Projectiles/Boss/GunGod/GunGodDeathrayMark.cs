...
namespace Albedo.Projectiles.Boss.GunGod
{
	public class GunGodDeathrayMark : BaseDeathray
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				Projectile.NewProjectile(projectile.Center, projectile.velocity, ModContent.ProjectileType<GunGodDeathray>(), projectile.damage, projectile.knockBack, projectile.owner, projectile.ai[0], projectile.ai[1]);
			}
		}
	}
}
