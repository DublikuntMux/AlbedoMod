...
{
	public class GunGodDeathrayMark : BaseDeathray
	{
		public GunGodDeathrayMark()
			: base(30f, "GunGodDeathray")
		{
		}
		...
		public override void AI()
		{
			...
			if (Main.rand.NextBool(5)) {
				...
				int num7 = Dust.NewDust(vector2 + vector4 - Vector2.One * 4f, 8, 8, 244, 0f, 0f, 100, default, 1.5f);
		...
		public override void Kill(int timeLeft)
		{
			if (Main.netMode != NetmodeID.MultiplayerClient)
				Projectile.NewProjectile(projectile.Center, projectile.velocity,
					ModContent.ProjectileType<GunGodDeathray>(), projectile.damage, projectile.knockBack,
					projectile.owner, projectile.ai[0], projectile.ai[1]);
		}
	}
}