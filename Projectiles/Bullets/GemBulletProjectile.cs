...
namespace Albedo.Projectiles.Bullets
{
    public class GemBulletProjectile : BasBulletProjectile
    {
        ...
        public override void AI()
        {
            ...
            var dust = Dust.NewDust(projectile.Center, 1, 1, 15, 0f, 0f, 0, default, 0.6f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (var i = 0; i < 20; i++) Dust.NewDust(projectile.position, projectile.width, projectile.height, 15);
        }
    }
}