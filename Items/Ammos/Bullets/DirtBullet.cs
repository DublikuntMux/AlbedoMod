...
{
	public class DirtBullet : BaseBullet
	{
		...
		protected override int BulletMaterial => ItemID.DirtBlock;
		protected override int BulletProjectile => ModContent.ProjectileType<DirtBulletProjectile>();
	}
}
