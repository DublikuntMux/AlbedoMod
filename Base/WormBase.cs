...
namespace Albedo.Base
{
	public abstract class WormBase : ModNPC
	{
		...
		public override void SetStaticDefaults() => NPCID.Sets.TechnicallyABoss[npc.type] = true;
		...
		{
			if (Main.expertMode || Main.rand.NextBool()) player.AddBuff(BuffID.OnFire, 180);
		}
