...
{
	public class WeaponStation3Tile : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault(Language.GetTextValue("Mods.Albedo.ItemName.WeaponStation3"));
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) =>
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<WeaponStation3>());
